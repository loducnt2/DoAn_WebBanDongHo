					...
					<div class="shop_sidebar">
						<div class="sidebar_section">
							...
							@foreach($cate as $item)
									<li style="padding-top: 10px;"><a href='{{ url("category/$item->id") }}'>{{ $item->name_cate }}</a></li>
									<!-- day nhe - in DS các thương hiệu theo DM -->
		                	@endforeach
							</ul>
						</div>
				...
				<div class="col-lg-9">
					...
					<div class="shop_content">
						...
						@foreach($product_cate as $item)
							<?php $dem++; ?>
						@endforeach
							<div class="shop_product_count"><span><?php echo $dem; ?></span>&nbsp; 
			...
			<div class="row">
				<div class="col">
					<div class="brands_slider_container">
						...
						@foreach($tra_relative_shop as $item)
							<div class="owl-item">
