                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <div class="row">
                                <div class="col-sm-8">
                                    <a href="{{ url('admin/post/create') }}">Thêm mới bài viết</a>
                                </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1"
                                            colspan="1" aria-label="Browser: activate to sort column ascending">Tiêu đề
                                        </th>
                                        <!-- <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1"
                                            colspan="1" aria-label="Browser: activate to sort column ascending">Tóm tắt
                                        </th> -->
                                        <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1"
                                ...
                                <tbody>
                                    @foreach($posts as $item)
                                        <tr class="even gradeC">
                                            <td>{{ $item->id }}</td>
                                            <td>
                                                <img src='{{ url("upload/post/$item->thumbnail") }}' width="100px" height="100px" width="50px" height="50px"> 
                                            </td>
                                            <td>{{ $item->title }}</td>
                                            <!-- <td>{{ $item->summary }}</td> -->
                                            <td>{{ $item->contents }}</td>
