			...
			<div class="row">
				<div class="col-lg-10 offset-lg-1">
					...
					<div class="cart_container">
						<div class="cart_title" style="font-family: arial; font-weight: bold;">Đơn hàng gồm: </div>
					...
					<div class="cart_container" style="margin-top: 50px;">
						<div class="cart_title" style="font-family: arial; font-weight: bold;">Cập nhật hóa đơn:</div>
